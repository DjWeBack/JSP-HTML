...
/* 		    columns:[[
	...
	<!--============================= 툴바 끝 =================================-->
	<!-- 회원 목록 시작 -->
	<table id="dg_member" class="easyui-datagrid" url="../json/memberJSON.json">
	        <thead>
            <tr>
                <th field="mem_ck" checkbox="true"></th>
                <th field="mem_id" width="120">아이디</th>
                <th field="mem_name" width="150">이름</th>
                <th field="mem_gender" width="80">성별</th>
                <th field="mem_hp" width="170">HP</th>
            </tr>
        </thead>
	</table>
