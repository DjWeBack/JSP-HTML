...
/* 		$("#dg_member").datagrid({
	...
	data-options="url:'../json/memberJSON.json',fitColumns:true,singleSelect:false,selectOnCheck:false">
		<thead>
			<tr>
			    <th field='mem_ck' width=100 checkbox='true'></th>
				<th field='mem_id' width=150>아이디</th>
