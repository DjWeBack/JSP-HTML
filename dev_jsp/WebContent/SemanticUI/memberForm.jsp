...
<table align="center">
	...
	<td width="250px"><input id="zipcode" name="zipcode" class="easyui-textbox" data-options="iconCls:'icon-search'" style="width:200px"></td>
	</tr>
		<tr>
		<script type="text/javascript">
	$('#zipcode').searchbox({
				...
				$('#dg_zipcode').datagrid({
					url:'./member.kos?gubun=zipcode&dong='+value,
							...
							onDblClickRow:function(index, row){
								...
								$('#zipcode').testbox('setValue',row.ZIPCODE);
	...
	<td width="250px"><input id="address" name="address" class="easyui-textbox" style="width:200px"></td>
	</tr>
	<script type="text/javascript">
	$('#address').textbox({
